...
namespace twisty {
/**
 * @brief Three control point bezier curve. Exists for the parameter space t in
 * [0, 1]
 *
 */
class BezierCurve3 {
public:
  /**
   * @brief Construct a new Bezier Curve 3 object, initializes the control
   * points to all 0.0f
   *
   */
  BezierCurve3();
...
/**
 * @brief Four control point bezier curve. Exists for the parameter space t in
 * [0, 1]
 *
 */
class BezierCurve4 {
...
/**
 * @brief Five control point bezier curve. Exists for the parameter space t in
 * [0, 1]
 *
 */
class BezierCurve5 {
public:
   ...
   * arclength. Verified with the formula at:
