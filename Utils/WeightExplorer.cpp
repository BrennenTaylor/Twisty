...
int main(int argc, char *argv[])
{
    ...
    experimentParams.experimentDirPath = "C:/Experiments/WeightExplorer/";
    ...
    const float ds = 13.0 / experimentParams.numSegmentsPerCurve;

    twisty::PathWeighting::WeightLookupTableIntegral standardWeightLookup(
          experimentParams.weightingParameters, ds);
    standardWeightLookup.ExportValues(experimentParams.experimentDirPath);
}