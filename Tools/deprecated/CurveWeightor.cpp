...
int main(int argc, char *argv[])
{
    ...
    boost::multiprecision::cpp_dec_float_100 bigFloatCurveWeight
          = boost::multiprecision::pow(10.0, bigFloatCurveWeightLog10);
    ...
    pathNormalizer = pathNormalizer
          * boost::multiprecision::pow(
                boost::multiprecision::cpp_dec_float_100(
                      static_cast<float>(upCurve->m_numSegments) / upCurve->m_arclength),
                3.0);
    ...
    std::cout << "Normalized Weight (Log10): " << bigFloatCurveWeightLog10 + pathNormalizerLog10
              << std::endl;
    std::cout << "Normalized Weight (Multiplied): " << bigFloatCurveWeight * pathNormalizer
              << std::endl;
    std::cout << "Normalized Weight (Decompressed): "
              << boost::multiprecision::pow(10.0, (bigFloatCurveWeightLog10 + pathNormalizerLog10))
              << std::endl;
}